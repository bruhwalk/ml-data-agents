...
Usage::
    ...
    python run_pipeline.py "News topic text classification"
...
For the full interactive experience, use /data-pipeline in Claude Code instead.
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print('Example: python run_pipeline.py "News topic text classification"')
        sys.exit(1)
    main(sys.argv[1])
